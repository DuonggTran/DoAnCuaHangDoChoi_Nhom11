...
namespace DoAnCuaHangDoChoi
{
    public partial class frmThongKe : Form
    {
        ...
        void LoadForm()
        {
            lblDoanhThuThang.Text = tk.DoanhThuThang().ToString();
            lblLoiNhuanThang.Text = tk.LoiNhuanThang().ToString();
        ...
        private void pnChiTiet_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void btnLoiNhuanTheoNam_Click(object sender, EventArgs e)
        {
