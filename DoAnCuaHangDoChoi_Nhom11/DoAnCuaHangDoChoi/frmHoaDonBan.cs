    ...
    public partial class frmHoaDonBan : Form
    {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dgvDanhSachHoaDonBan.CurrentCell == null)
                {
                ...
                string strMaHoaDonBan = dgvDanhSachHoaDonBan.Rows[r].Cells[0].Value.ToString();
                ...
                if (traloi == DialogResult.Yes)
                {
                    ...
                    kq = hdbbusiness.XoaHoaDonBan(ref err, strMaHoaDonBan);
            ...
            {
                MessageBox.Show("Không xóa được hóa đơn bán này. Lỗi rồi! " + ex.Message);
            }
        }
