    ...
    public partial class frmHoaDonNhap : Form
    {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dgvDanhSachHoaDonNhap.CurrentCell == null)
                {
                ...
                // Lấy MaHoaDonBan của record hiện hành từ DataGridView
                string strMaHoaDonNhap = dgvDanhSachHoaDonNhap.Rows[r].Cells[0].Value.ToString();

                // Hiện thông báo xác nhận việc xóa mẫu tin 
                DialogResult traloi;
                traloi = MessageBox.Show("Bạn có chắc muốn xoá loại hóa đơn bán này không?",
                                          "Trả lời", MessageBoxButtons.YesNo, MessageBoxIcon.Question);

                // Nếu chọn Yes, thực hiện lệnh xóa
                if (traloi == DialogResult.Yes)
                {
                    // Thực hiện câu lệnh SQL với MaHoaDonBan từ DataGridView
                    kq = hdnbusiness.XoaHoaDonNhap(ref err, strMaHoaDonNhap);
                    ...
                    else
                    {
                        ...
                        MessageBox.Show("Xóa không thành công: " + err);
                    }
                }
                else
                {
            ...
            {
                MessageBox.Show("Không xóa được hóa đơn nhập này. Lỗi rồi! " + ex.Message);
            }
        }
